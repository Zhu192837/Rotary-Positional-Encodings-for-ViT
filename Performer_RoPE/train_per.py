...
from dataset_per import build_dataset
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='rope_mixed_ape_performer_small', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/jz3849/rope-vit/cifar/', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default='/home/jz3849/rope-vit/output',
...
def main(args):
    if args.batch_size % 2 != 0:
        print(f"Batch size {args.batch_size} is odd, adjusting to {args.batch_size + 1}")
        args.batch_size += 1
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch == args.epochs - 1:
            print("\nCalculating inference speed for the last epoch...")
            model.eval()
            ...
            # 计算推理的吞吐量和延迟
            throughput = total_samples / total_time_inference
            latency = total_time_inference / total_samples

            print(f"Inference Throughput: {throughput:.2f} samples/second")
            print(f"Inference Latency: {latency:.6f} seconds/sample")
