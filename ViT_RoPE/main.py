...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='rope_mixed_ape_vit_base_patch16_LS', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    #parser.add_argument('--data-path', default='/home/jz3849/imgnet/', type=str,
                        #help='dataset path')
